...
REDEEM_URL = "https://chong.zygtoken.com/"
...
DEFAULT_SETTINGS = {
    ...
    "steps": ["联系微信客服获取充值 CDK", "进入充值页面填写 CDK", "充值到自己的 GPT 账号"],
    "products": [
...
.redeem-flow{position:relative;margin:8px 0 40px;padding:26px;border:1px solid #4b8c70;border-radius:22px;background:radial-gradient(circle at 50% 0,#173d2d 0,transparent 60%),#0a1511;box-shadow:0 0 42px rgba(98,246,175,.12);overflow:hidden}.redeem-flow:before{content:"REDEEM";position:absolute;right:18px;top:-18px;color:#62f6af0d;font:900 92px/1 ui-monospace,SFMono-Regular,Consolas,monospace;letter-spacing:-.08em;pointer-events:none}.flow-head{position:relative;display:flex;align-items:end;justify-content:space-between;gap:18px;margin-bottom:18px}.flow-head small{display:block;margin-bottom:4px;color:var(--green);font:800 10px/1.2 ui-monospace,SFMono-Regular,Consolas,monospace;letter-spacing:.16em}.flow-head h2{margin:0;font-size:30px}.flow-head p{margin:0;color:#c4d8ce;font-size:14px}.steps{position:relative;display:grid;grid-template-columns:repeat(3,1fr);gap:18px;padding:0;list-style:none;counter-reset:step}.steps li{position:relative;display:grid;grid-template-columns:auto 1fr;align-items:start;gap:13px;min-height:148px;padding:20px;border:1px solid #315846;border-radius:16px;background:linear-gradient(145deg,#10261c,#0b1813)}.steps li:nth-child(2){border-color:#69d9ff;background:linear-gradient(145deg,#12302c,#0d2024);box-shadow:0 0 26px rgba(105,217,255,.16)}.steps li:not(:last-child):after{content:"›";position:absolute;z-index:2;right:-15px;top:50%;display:grid;width:28px;height:28px;place-items:center;border:1px solid #47755f;border-radius:50%;background:#0a1511;color:var(--green);font-size:24px;line-height:1;transform:translateY(-50%)}.step-number{display:grid;width:40px;height:40px;place-items:center;border-radius:11px;background:var(--green);color:#07120d;font:900 15px/1 ui-monospace,SFMono-Regular,Consolas,monospace}.step-copy{display:grid;gap:7px}.step-copy small{color:#86a99a;font:800 9px/1.2 ui-monospace,SFMono-Regular,Consolas,monospace;letter-spacing:.14em}.step-copy strong{font-size:17px;line-height:1.45}.redeem-button{display:inline-flex;width:max-content;max-width:100%;align-items:center;gap:7px;margin-top:5px;padding:9px 13px;border-radius:9px;background:linear-gradient(105deg,var(--green),var(--cyan));box-shadow:0 0 18px rgba(105,217,255,.24);color:#06120d;font-size:13px;font-weight:900;text-decoration:none}.redeem-button:hover{filter:brightness(1.1);transform:translateY(-1px)}footer{margin-top:32px;padding-top:20px;border-top:1px solid #1f3a2e;color:var(--muted);font-size:13px;text-align:center}
@media(max-width:850px){.hero{grid-template-columns:1fr}.qr-card{max-width:480px}.products{grid-template-columns:repeat(2,1fr)}.steps{grid-template-columns:1fr}.steps li{min-height:0}.steps li:not(:last-child):after{right:auto;left:26px;top:auto;bottom:-24px;transform:rotate(90deg)}}@media(max-width:560px){main{padding-top:20px}.signal-bar{align-items:flex-start}.signal-bar div{display:grid;gap:6px}.brand-stage{gap:14px;padding:14px 16px}.openai-mark{width:58px;height:58px}.openai-name{font-size:19px}.service-name{font-size:27px}.service-meta{font-size:8px}.identity{align-items:flex-start;flex-wrap:wrap}.identity-name{font-size:11px}.badge{font-size:10px}.redeem-flow{padding:20px 16px}.flow-head{display:block}.flow-head p{margin-top:6px}.products{grid-template-columns:1fr}.product-card{min-height:0}h1{font-size:42px}}@media(prefers-reduced-motion:reduce){.ai-core{animation:none}.redeem-button:hover{transform:none}}
"""
...
def public_page(settings):
    ...
    steps = "".join(
        f"<li><span class='step-number'>{index + 1:02d}</span><div class='step-copy'><small>STEP {index + 1:02d}</small><strong>{esc(text)}</strong>"
        + (f"<a class='redeem-button' href='{REDEEM_URL}' target='_blank' rel='noreferrer'>进入充值页面 <span aria-hidden='true'>↗</span></a>" if index == 1 else "")
        + "</div></li>"
...
<section class="redeem-flow" aria-labelledby="redeem-title"><div class="flow-head"><div><small>CDK RECHARGE WORKFLOW</small><h2 id="redeem-title">充值流程</h2></div><p>获取 CDK 后，按三步充值到自己的 GPT 账号</p></div><ol class="steps">{steps}</ol></section>
