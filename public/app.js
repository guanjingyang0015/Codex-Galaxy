...
const translations = {
  "zh-CN": {
    ...
    "page.title": "账号与 API",
    "page.summaryLabel": "功能概览",
    "page.summary.switch": "账号切换",
    "page.summary.audit": "API 检测与排名",
    "page.summary.health": "24 小时健康度",
    ...
    "tutorial.intro": "按使用阶段阅读教程：先完成一次账号配置，日常按步骤切换，出问题先看日志，超大聊天先复制深度链接新建聊天继续，最后了解本地历史和其他特色功能。当前版本为 v3.0.2。",
  ...
  "en": {
    ...
    "page.summaryLabel": "Feature overview",
    "page.summary.switch": "Account switching",
    "page.summary.audit": "API audit and ranking",
    "page.summary.health": "24-hour health",
    ...
    "tutorial.intro": "Read the guide by stage: configure accounts once, follow the daily switch steps, preserve the scene when something fails, use a deep link to continue oversized chats in a new thread, then learn local history and other features. Current version: v3.0.2.",
