...
contextBridge.exposeInMainWorld("codexGalaxy", {
  ...
  getOpenAIStatus: () => ipcRenderer.invoke("codex-galaxy:get-openai-status"),
  setOpenAIStatusPinned: (component) => ipcRenderer.invoke("codex-galaxy:set-openai-status-pinned", component),
  openOpenAIStatus: () => ipcRenderer.invoke("codex-galaxy:open-openai-status"),
